...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "aboutTadamon": MessageLookupByLibrary.simpleMessage("حول تطبيق تضامن."),
    ...
    "appOffLineMassageDontRunning": MessageLookupByLibrary.simpleMessage(
      "التطبيق غير متصل.",
    ),
    "appOflineLoading": MessageLookupByLibrary.simpleMessage("انتظر ..."),
    "appOnLineMassageRunning": MessageLookupByLibrary.simpleMessage(
      "التطبيق يعمل بنجاح.",
    ),
    ...
    "devMassage": MessageLookupByLibrary.simpleMessage("لا توجد رسالة حالياً."),
    ...
    "enableOnline": MessageLookupByLibrary.simpleMessage(
    ...
    "githubTiket": MessageLookupByLibrary.simpleMessage("تذكرة على جيت هاب"),
    ...
    "mostafaMahmoud": MessageLookupByLibrary.simpleMessage("Mostafa Mahmoud"),
    "noPage": MessageLookupByLibrary.simpleMessage("لم يتم العثور على الصفحة"),
    "noRoutes": MessageLookupByLibrary.simpleMessage(
    ...
    "reportProduct": MessageLookupByLibrary.simpleMessage("الإبلاغ عن منتج"),
    "reportProductMassage": MessageLookupByLibrary.simpleMessage(
      "ساعدنا في تحسين التطبيق.",
    ),
    "scanBarcode": MessageLookupByLibrary.simpleMessage("فحص الباركود"),
    "scanedProducts": MessageLookupByLibrary.simpleMessage(
      "المنتجات التي تمت مراجعتها",
    ),
    "search": MessageLookupByLibrary.simpleMessage("بحث"),
    "sheetTitleProductInfo": MessageLookupByLibrary.simpleMessage(
      "تفاصيل المنتج",
    ),
    "supportedProducts": MessageLookupByLibrary.simpleMessage(
      "المنتجات التي تم دعمها",
    ),
    "switchToDarkTheme": MessageLookupByLibrary.simpleMessage(
      "التبديل إلى الوضع الداكن",
    ),
    "switchToLightTheme": MessageLookupByLibrary.simpleMessage(
      "التبديل إلى الوضع الفاتح",
    ),
    "systemTheme": MessageLookupByLibrary.simpleMessage("لون واجهة التطبيق"),
    "telegramChannel": MessageLookupByLibrary.simpleMessage("قناة تلغرام"),
    "telegramChannelMassage": MessageLookupByLibrary.simpleMessage(
